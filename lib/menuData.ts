...
export const menuCategories: MenuCategory[] = [
  {
    ...
    description: 'Sabores frescos para despertar el paladar antes de lo principal.',
    sections: [
      {
        section: 'Entradas Frías',
        items: [
          { name: 'Ceviche de Salmón', description: 'Salmón fresco, cebolla morada, pimentones, cilantro, palta, choclo peruano aderezado con leche de tigre, acompañado de tostadas.', price: '$13.500' },
          { name: 'Ceviche de Atún', description: 'Dados de atún fresco, cebolla morada, pimentones, cilantro, pepino fresco, aliñado con limón sutil, ralladura de naranja y limón. Acompañado de tostadas de la casa.', price: '$13.500' },
          { name: 'Ensalada César', description: 'Mix de hojas verdes, filete de pollo grillado, crutones, queso parmesano, tomate cherry, dressing tradicional César.', price: '$10.500' },
          { name: 'Ceviche Vegetariano 🌱', description: 'Champiñones, palmitos, cebolla morada, pimentones y palta.', price: '$12.000' },
        ]
      }
    ]
  },
  {
    name: 'Principales',
    subtitle: 'FONDOS Y PASTAS',
    description: 'Platos de fondo preparados con ingredientes de primera calidad.',
    sections: [
      {
        section: 'Fondos y Carnes',
        items: [
          { name: 'Filete Mignon', description: 'Carne nacional en una reducción de vino tinto, arándanos y romero.', price: '$21.500' },
          { name: 'Lomo Vetado Nacional', description: 'Corte de 400 g de carne nacional.', price: '$23.900' },
          { name: 'Pollo a la Plancha', description: 'Pechuga de pollo grillado a las finas hierbas.', price: '$13.900' },
        ]
      },
      {
        section: 'Pastas',
        items: [
          { name: 'Fetuccini con Lomo Saltado', description: 'Fetuccini acompañado de lomo saltado en su jugo con tomates cherry confitado y cebollín fresco.', price: '$13.900' },
          { name: 'Fetuccini y Setas 🌱', description: 'Fetuccini con setas y zucchini salteado en mantequilla de romero.', price: '$10.500' },
          { name: 'Fetuccini con Camarones', description: 'Fetuccini en cremoso de camarones y ciboulette fresco.', price: '$12.400' },
        ]
      },
      {
  ...
  {
    name: 'Para Compartir',
    subtitle: 'TABLAS Y PAPAS',
    description: 'Porciones generosas para disfrutar entre amigos.',
    sections: [
      {
        section: 'Papas para Compartir',
        items: [
          { name: 'Las Mechadas', description: 'Papas fritas (700grs) aderezadas con aceite de ajo, jengibre, salsa cheddar, tiritas de carne mechada, tocino crocante, queso en cubos y cebollín fresco con salsa verde.', price: '$18.900' },
          { name: 'La Vegetariana 🌱', description: 'Base de papas fritas (700grs) aderezadas con aceite de ajo, jengibre, salsa de champiñones, verduras glaseadas, tomate cherry confitados, aceitunas y salsa coleslaw.', price: '$15.700' },
        ]
      },
      {
        section: 'Tablas',
      ...
      },
      {
        section: 'Picoteo',
        items: [
          { name: 'Papas Fritas de la Casa (2 p)', description: '', price: '$8.500' },
          { name: '6 Empanadas Queso', description: '', price: '$10.500' },
        ]
      }
    ]
  },
  {
    name: 'Hamburguesas',
    subtitle: 'HOUSE ORIGINALS',
    description: 'Corte angus premium en pan brioche artesanal.',
    sections: [
      {
  ...
  },
  {
    ...
    description: 'Clásicos chilenos y creaciones de la casa.',
    sections: [
      {
        section: 'Clásicos',
        items: [
          { name: 'Chacarero', description: 'Carne mechada, tomates asados, porotos verdes, ají verde y mayonesa casera en pan marraqueta.', price: '$11.900' },
          { name: 'Churrasco Italiano', description: 'Churrasco de res, palta, tomate y mayonesa casera.', price: '$11.900' },
          { name: 'Ave Italiano', description: 'Filete de pollo, palta, tomate y mayonesa de la casa.', price: '$11.900' },
          { name: 'Barros Luco', description: 'Carne de res con doble queso fundido.', price: '$11.900' },
        ]
      },
      {
        section: 'Especialidades Basildon',
        items: [
          { name: 'El New Wave', description: 'Mechada, tocino crocante, queso, cebolla caramelizada, huevo frito, palta y mayonesa.', price: '$11.500' },
          { name: 'El Brit', description: 'Filete de pollo, lechuga, pepinos frescos, palta e cebolla morada.', price: '$11.200' },
          { name: 'El Synth-Pop', description: 'Finas láminas de res, queso azul fundido, champiñones salteados, pimentones asados, palta e chimichurri.', price: '$12.900' },
          { name: 'El New Romantic 🌱', description: 'Croquetas de berenjenas apanadas, ensalada de champiñones (cebolla morada, cilantro y tomate), queso de cabra.', price: '$10.900' },
          { name: 'El Dark', description: 'Finas láminas de res, queso mantecoso, jamón serrano crocante e cebolla caramelizada.', price: '$11.900' },
          { name: 'El Post Punk', description: 'Jamón serrano, rúcula fresca, ricota saborizada, cebolla morada fina, aceitunas y dressing de la casa.', price: '$11.700' },
        ]
      }
    ]
  },
  {
    name: 'Pizzas',
    subtitle: 'PREMIUM',
    description: 'Pizzas artesanales con ingredientes frescos y de calidad.',
    sections: [
      {
        section: 'Pizzas',
        items: [
...
export const tragosCategories: MenuCategory[] = [
  {
    name: 'Cocktails',
    subtitle: 'SIGNATURE MIXOLOGY',
    description: 'Cócteles de autor y clásicos contemporáneos preparados con técnica y pasión.',
    sections: [
      {
...
export const bebestiblesCategories: MenuCategory[] = [
  {
    name: 'Bebestibles',
    subtitle: 'SIN ALCOHOL',
    description: 'Refrescos, cafés y jugos naturales para todos los gustos.',
    sections: [
      {
        section: 'Sin Alcohol',
        items: [
